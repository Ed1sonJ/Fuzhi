...
=======
		//ËÆæÁΩÆËÉåÊôØÈ¢úËâ≤‰∏∫ÈªëËâ≤
		popupWindow.setBackgroundDrawable(new ColorDrawable(
				android.graphics.Color.BLACK));
		//ËÆæÁΩÆÁÇπÂáªpopWinÊóÅËæπÂèØ‰ª•ÈöêËóè
		popupWindow.setOutsideTouchable(true);
		//ËÆæÁΩÆËé∑ÂæóÁÑ¶ÁÇπ
...
<<<<<<< HEAD
			Intent wrapperIntent = Intent.createChooser(innerIntent, "—°‘Ò∂˛Œ¨¬ÎÕº∆¨");
=======
			Intent wrapperIntent = Intent.createChooser(innerIntent, "ÈÄâÊã©‰∫åÁª¥Á†ÅÂõæÁâá");
>>>>>>> a5941f52e66153da3adc5249e8a7623c1909da04
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case 1:
					...
					if (resultString.equals("")) {
						Toast.makeText(CaptureActivity.this, "…®√Ë ß∞‹!",
				...
				case 2:
					mProgress.dismiss();
					Toast.makeText(CaptureActivity.this, "Ω‚Œˆ¥ÌŒÛ£°", Toast.LENGTH_LONG)
							.show();
				...
				case 1:
					try {
						...
						if (!TextUtils.isEmpty(uri.getAuthority())) {
							//Ëé∑ÂèñÈÄâ‰∏≠ÂõæÁâáÁöÑË∑ØÂæÑ
							Cursor cursor = getContentResolver().query(uri,
									new String[] { MediaStore.Images.Media.DATA },
									null, null, null);
							if (null == cursor) {
								Toast.makeText(this, "Õº∆¨√ª’“µΩ", Toast.LENGTH_SHORT)
										.show();
								return;
							}
							cursor.moveToFirst();
						...
						Toast.makeText(CaptureActivity.this, "Ω‚Œˆ¥ÌŒÛ£°",
	...
	public Result scanningImage(String path) {
		...
		hints.put(DecodeHintType.CHARACTER_SET, "UTF8"); // …Ë÷√∂˛Œ¨¬Îƒ⁄»›µƒ±‡¬Î

		BitmapFactory.Options options = new BitmapFactory.Options();
<<<<<<< HEAD
		options.inJustDecodeBounds = true; // œ»ªÒ»°‘≠¥Û–°
		scanBitmap = BitmapFactory.decodeFile(path, options);
		options.inJustDecodeBounds = false; // ªÒ»°–¬µƒ¥Û–°
=======
		options.inJustDecodeBounds = true; //ËÆæÁΩÆ‰∏çÂä†ËΩΩÂà∞ÂÜÖÂ≠òÔºåÊñπ‰æøÂéãÁº©
		scanBitmap = BitmapFactory.decodeFile(path, options);
		options.inJustDecodeBounds = false; //ËÆæÁΩÆÂä†ËΩΩÂà∞ÂÜÖÂ≠òÔºåÂä†ËΩΩÁöÑÊòØÂéãÁº©ÂêéÁöÑÁÖßÁâá
>>>>>>> a5941f52e66153da3adc5249e8a7623c1909da04
