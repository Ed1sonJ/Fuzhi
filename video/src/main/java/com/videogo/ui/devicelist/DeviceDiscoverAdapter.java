...
public class DeviceDiscoverAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(deviceDiscoverInfo != null) {
            viewHolder.serialTv.setText(deviceDiscoverInfo.deviceID);
            viewHolder.addBtn.setTag(deviceDiscoverInfo.deviceID);
            if(deviceDiscoverInfo.isAdded) {
                viewHolder.addBtn.setText(deviceDiscoverInfo.cameraInfo!=null?R.string.added_by_me:R.string.added_by_other);
            } else {
