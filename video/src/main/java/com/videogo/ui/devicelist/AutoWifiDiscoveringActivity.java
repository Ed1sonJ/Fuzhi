...
public class AutoWifiDiscoveringActivity extends Activity implements OnClickListener {
    ...
    private void findViews() {
        ...
        //mj mj mj imgStatus = (ImageView) findViewById(R.id.imgStatus);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (!isFinishing()
                    ...
                    oneStepWifiConfigurationManager.startBonjour(deviceDiscoveryListener);
                }
            }
        }).start();
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (!isFinishing()
                        && ConnectionDetector.getConnectionType(AutoWifiDiscoveringActivity.this) == ConnectionDetector.WIFI
                        && oneStepWifiConfigurationManager != null) {
                    oneStepWifiConfigurationManager.startSmartBonjour(deviceDiscoveryListener);
                }
            }
        }).start();
    }
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.btnBack) {// 设备切换wifi界面来的，且已连接成功
