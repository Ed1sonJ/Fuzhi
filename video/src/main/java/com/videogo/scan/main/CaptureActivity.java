...
//        WebUtils.openDeviceConnectHelp(this);
    ...
    private void openPromptWindow(View parent) {/*
        ...
        ViewGroup layoutView = (ViewGroup) mLayoutInflater.inflate(R.layout.add_device_via_scan_tip_wnd, null, true);
        LinearLayout layout = (LinearLayout) layoutView.findViewById(R.id.add_device_via_scan_tip_ly);
        ...
        layoutView.findViewById(R.id.i_know_btn).setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View view) {
//                HikStat.onEvent(CaptureActivity.this, HikAction.ACTION_device_add_guide_tip);
                closePromptWindow();
            }

        });
        mPromptWindow = new PopupWindow(layoutView, LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, true);
        // mPromptWindow.setBackgroundDrawable(new BitmapDrawable());
        // mPromptWindow.setAnimationStyle(R.style.popupAnimation);
        mPromptWindow.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        mPromptWindow.showAtLocation(parent, Gravity.CENTER | Gravity.CENTER, 0, 0);
        mPromptWindow.update();
    */}
