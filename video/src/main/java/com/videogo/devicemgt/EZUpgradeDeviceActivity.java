...
//                            showUpgradeSuccess();
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    mUpgradeStatus = EZOpenSDK.getInstance().getDeviceUpgradeStatus(mDeviceSerial);
    ...
    private void startUpgrade() {
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    EZOpenSDK.getInstance().upgradeDevice(mDeviceSerial);
                    mTimer = new Timer();
                    mTimer.schedule(new TimerTask() {
                        @Override
                        public void run() {
    ...
    private void showVersionViewOnce() {
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    mVersion = EZOpenSDK.getInstance().getDeviceVersion(mDeviceSerial);
