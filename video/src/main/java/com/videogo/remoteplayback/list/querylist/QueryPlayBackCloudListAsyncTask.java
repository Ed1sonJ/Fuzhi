...
//    private RemoteListFileCtrl remoteListFileCtrl = null;
    ...
    public QueryPlayBackCloudListAsyncTask(String cameraId, String deviceSerial, int channelNo, DeviceInfoEx deviceInfoEx,
...
//        cloudPartFiles = remoteListFileCtrl.queryCloudPartInfo(deviceSerial, channelNo, startTime);
		...
		try {
			tmpList = mEZOpenSDK.searchRecordFileFromCloud(mCameraId,
					startTime, endTime);
